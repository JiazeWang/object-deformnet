...
parser.add_argument('--num_workers', type=int, default=14, help='number of data loading workers')
...
parser.add_argument('--result_dir', type=str, default='results/T3_STAGE3_CAMERA', help='directory to save train results')
