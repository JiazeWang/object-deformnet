...
from lib.network_t4_t4 import DeformNet
...
parser.add_argument('--result_dir', type=str, default='results/T4_four_transformer', help='directory to save train results')
