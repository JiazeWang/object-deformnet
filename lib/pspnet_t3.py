...
class PSPNet(nn.Module):
    def __init__(self, bins=(1, 2, 3, 6), backend='resnet18'):
        ...
        self.up_0_0 = PSPUpsample(1024, 32)
        self.up_0_1 = PSPUpsample(32, 32)
        self.up_0_2 = PSPUpsample(32, 32)
        self.up_0_3 = nn.Conv2d(32, 32, kernel_size=1)
        self.drop = nn.Dropout2d(p=0.15)
        self.up_1 = PSPUpsample(1024, 32)
        self.up_1_1 = PSPUpsample(32, 32)
        self.up_1_2 = PSPUpsample(32, 32)
        self.up_1_3 = nn.Conv2d(32, 32, kernel_size=1)
        self.up_2 = PSPUpsample(32, 32)
        self.up_2_1 = PSPUpsample(32, 32)
        self.up_2_2 = nn.Conv2d(32, 32, kernel_size=1)
        self.up_3 = PSPUpsample(32, 32)
