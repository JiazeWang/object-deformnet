...
parser.add_argument('--model', type=str, default='results/T5_three_stage/model_50.pth', help='resume from saved model')
...
if opt.data == 'val':
    result_dir = 'results/eval_camera_t5_three_stage2'
    file_path = 'CAMERA/val_list.txt'
    cam_fx, cam_fy, cam_cx, cam_cy = 577.5, 577.5, 319.5, 239.5
else:
    result_dir = 'results/eval_real_t5_three_stage2'
