...
parser.add_argument('--model', type=str, default='results/T5_2105_three_stage_real_1110/model_74.pth', help='resume from saved model')
...
if opt.data == 'val':
    ...
    result_dir = 'results/real74_test'
