...
parser.add_argument('--model', type=str, default='results/T3_STAGE3_R_CAMERA/model_50.pth', help='resume from saved model')
...
if opt.data == 'val':
    result_dir = 'results/eval_T3_STAGE3_R_CAMERA'
    file_path = 'CAMERA/val_list.txt'
    cam_fx, cam_fy, cam_cx, cam_cy = 577.5, 577.5, 319.5, 239.5
else:
    result_dir = 'results/eval_T3_STAGE3_R_real'
