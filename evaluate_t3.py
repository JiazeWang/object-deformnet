...
parser.add_argument('--model', type=str, default='results/T5_2105_three_stage_real_1110/model_45.pth', help='resume from saved model')
...
if opt.data == 'val':
    ...
    result_dir = 'results/real45_test'
